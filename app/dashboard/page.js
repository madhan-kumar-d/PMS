      ...
      <div className="ml-64 flex-1 min-h-screen">
        ...
        <div className="sticky top-0 z-20 bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="w-9 h-9 flex items-center justify-center rounded-lg border border-slate-200 bg-white hover:bg-slate-50">
              ✉️
            </button>
            <div className="relative" id="userMenuWrap">
              ...
              {userMenuOpen && (
                <div className="absolute right-0 top-full mt-2 bg-white border border-slate-200 rounded-xl shadow-lg min-w-48 z-50">
                  ...
                  <a
                    href="#"
                    className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 block"
                  >
                    👤 My Profile
                  </a>
                  <a
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-700 text-white rounded-lg text-sm font-semibold hover:bg-blue-800 transition"
              >
                📅 New Appointment
              </a>
              <a
                href="/users/add"
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-white text-slate-700 border border-slate-200 rounded-lg text-sm font-semibold hover:bg-slate-50 transition"
              >
                ➕ Add User
              </a>
            </div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <a
              href="/users/add"
              className="bg-white rounded-xl border border-slate-200 p-5 text-center cursor-pointer hover:border-blue-500 hover:shadow-md transition block"
            >
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-slate-500 text-sm">
                Active doctors list will be displayed here
              </p>
            </div>
          </div>
        </div>
